...
<html>
    ...
    <body>
        ...
        <hr/>
            ...
            <p> Amortização é um processo de extinção de uma dívida através
            ...
            <div id='home-col1'>
                ...
                <p> Sistema de Amortização Constante (SAC) é uma forma de 
            ...
            <div id='home-col3'>
                <h2>Tabela Price</h2>
                <p> Tabela Price, também chamado de sistema francês de 
                    ...
                    amortização do valor emprestado.</p>
            ...
            <div id='home-col2'> 
                ...
                <p> O Sistema de Amortização Americano é uma forma de pagamento 
